        ...
        <>
            ...
            <StyledOuterContainer>
                <StyledInnerContainer>
                    ...
                    <StyledSection>
                        <Card title='Brief' icon={{src: '/img/icon1.png', width: 60, height: 60}} >Complete <b>brief writing or simple guidance</b> on what to include, we've got you covered.</Card>
                        <Card title='Search' icon={{src: '/img/icon2.png', width: 60, height: 60}} >In-depth agency search covering; <b>criteria matching,</b> door knocking and due-dilligence vetting.</Card>
